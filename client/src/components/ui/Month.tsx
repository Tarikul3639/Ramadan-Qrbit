        ...
        {tabs.map((tab) => (
          ...
          >
            ...
            {activeTab === tab.id && (
              <motion.div
                layoutId="underline"
                className="absolute -bottom-0.75 left-0 right-0 h-0.75 bg-primary rounded-full"
        ...
        <header className="flex flex-wrap justify-between items-end gap-6 mb-8">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-primary">
              <MapPin className="size-2.5 sm:size-3.5" />
            ...
            <p className="text-primary/70 text-sm sm:text-base font-normal">
